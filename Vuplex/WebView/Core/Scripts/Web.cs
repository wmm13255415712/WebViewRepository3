...
namespace Vuplex.WebView {
    ...
    public static class Web {
        ...
        /// Important notes:
        /// <list type="bullet">
        ///   <item>On Windows and macOS, this method can only be called prior to initializing any webviews. So, you will likely need to call it from Awake().</item>
        ...
        /// <list type="bullet">
        ///   <item>
        ///     On Windows and macOS, this method can only be called prior to initializing any webviews. So, you will likely need to call it from Awake().
        ///   </item>
        ///   <item>

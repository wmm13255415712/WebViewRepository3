    ...
    #region Non-public members
        ...
        static void _initializePlugin() {
            ...
            WebView_initializePlugin(
                Marshal.GetFunctionPointerForDelegate<LogFunction>(_logInfo),
                Marshal.GetFunctionPointerForDelegate<LogFunction>(_logWarning),
                Marshal.GetFunctionPointerForDelegate<LogFunction>(_logError),
